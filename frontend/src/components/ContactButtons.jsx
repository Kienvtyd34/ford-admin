    ...
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col gap-4">
      ...
      >
        <img 
          ...
          className="w-8 h-8"
        />
        <span className="absolute right-16 bg-white text-blue-600 px-4 py-2 rounded-lg shadow-lg font-bold text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 border border-blue-100">
          Chat Zalo ngay
        </span>
      </a>
      ...
      >
        ...
        <span className="absolute right-16 bg-white text-red-600 px-4 py-2 rounded-lg shadow-lg font-bold text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 border border-red-100">
          Gọi: 0338.797.170
        </span>
      </a>
    </div>
